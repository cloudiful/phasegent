    ...
    fn overview_carries_no_issue_refs_or_flag_signatures() {
        ...
        assert!(
            install.contains("/phasegent-worktree-acquire")
                && install.contains("phasegent-worktree-v2")
